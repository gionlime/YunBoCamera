...
public class DemoListDataProvider {
    public static ArrayList<DemoItem> getDemoList() {
        ...
        arr.add(new DemoItem("云播SDK OpenGL显示摄像头预览", "SurfaceTexture", CameraPreviewActivity.class));
        arr.add(new DemoItem("云播SDK OpenGL播放视频", "MediaPlayer", VideoPreviewActivity.class));
        arr.add(new DemoItem("云播SDK OpenGL切换摄像头和视频", "MediaPlayer", CameraVideoPreviewActivity.class));
        arr.add(new DemoItem("云播SDK OpenGL预览并录制", "包含录制功能", PreviewAndRecorderActivity.class));
        arr.add(new DemoItem("云播SDK 预览视频", "mediacodec", VideoPreviewMediaCodecActivity.class));
        arr.add(new DemoItem("云播SDK 图像渲染效果", "opengl demo", OpenGLSample01Activity.class));
//        arr.add(new DemoItem("云播SDK 平滑过渡转场效果", "opengl demo", OpenGLTexture.class));
//        arr.add(new DemoItem("云播SDK 像素块转场效果", "opengl demo", OpenGLTexture02.class));
//        arr.add(new DemoItem("云播SDK 水波转场效果", "opengl demo", OpenGLTexture03.class));
